    ...
    void CommandPalette::_updateUIForStackChange()
    {
        ...
        if (auto automationPeer{ Automation::Peers::FrameworkElementAutomationPeer::FromElement(_searchBox()) })
        {
            automationPeer.RaiseNotificationEvent(
                ...
                fmt::format(RS_fmt(L"CommandPalette_NestedCommandAnnouncement"), ParentCommandName()),
            ...
            if (auto automationPeer{ Automation::Peers::FrameworkElementAutomationPeer::FromElement(_searchBox()) })
            {
                automationPeer.RaiseNotificationEvent(
                    ...
                    currentNeedleHasResults ?
                        winrt::hstring{ fmt::format(RS_fmt(L"CommandPalette_MatchesAvailable"), _filteredActions.Size()) } :
